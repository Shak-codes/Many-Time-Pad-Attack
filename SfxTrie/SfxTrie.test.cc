...
void runTests() {
  ...
  std::vector<int> results1 = trie.search(suffix1);
  if (!results1.empty()) {
  ...
  std::vector<int> results2 = trie.search(suffix2);
  ...
  std::string suffix3 = "x";
  std::vector<int> results3 = trie.search(suffix3);
  if (!results3.empty()) {
  ...
  if (!str_arr.empty()) {
    ...
    std::vector<int> results4 = trie.search(suffix4);
